...
def find_matching_item_and_index(input, list)
  ...
  find_matching_item_and_index("banana", list)  # Output: Input matches banana at index 1
  find_matching_item_and_index("pear", list)    # Output: Input does not match any item in the list
