...
void choose_conversion() {
  ...
  Serial.println("For choice [1] press type: 1 followed by your message then press enter.");
  Serial.println("For choice [2] press type: 2 followed by your code then press enter.(for morse code use ' for dots and - for dashes)");
