...
def choice(morse,engltr)
  ...
  if i == 1                                               # Checks answer if 1
    ...
    puts "Enter signal durations, use a signal longer than 1 second to differentiate between letters" # Gives short instruction on what must be done for the function to work
...
puts choice(morse,engltr)                                    # Starting the code