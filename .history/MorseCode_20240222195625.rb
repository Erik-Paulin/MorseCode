...
def choice(morse,engltr)
  ...
  if i == 1                                               # Checks answer if 1
    puts "Write a phrase in all caps"                     # Gives short instruction on what must be done for the 
    eng_to_morse_time(morse,engltr)                       # Calls the corresponding main function
  elsif i == 2                                            # Checks answer if 2
    "Enter signal durations, use a signal longer than 1 second to differentiate between letters" # Gives user prompt 
