...
def choice(morse,engltr)
  ...
  if i == 1                                               # Checks answer if 1
    puts "Write a phrase in all caps"                     # Gives short instruction on what must be done for the function to workeng_to_morse_time(morse,engltr)                       # Calls the corresponding main function
