...
def choice(morse,engltr)
  ...
  if i == 1                                               # Checks answer if 1
    ...
    puts "Enter signal durations, use a signal longer than 1.5 second (1500 milis) to differentiate between letters, finish with '.' " # Gives short instruction on what must be done for the function to work
